...
var Options = []Option{
	...
	{"pg.query.allow_count", "same as dev", "Enables ComplexQuery's \"count\" flag. See specs/complex-query.md ## Availability."},
	{"pg.query.allow_stats", "same as dev", "Enables ComplexQuery's \"stats\" flag. See specs/complex-query.md ## Availability."},
	{"pg.query.allow_query_plan", "same as dev", "Enables ComplexQuery's \"query_plan\" flag. See specs/complex-query.md ## Availability."},
	{"pg.query.allow_sql", "same as dev", "Enables ComplexQuery's \"sql\" flag. See specs/complex-query.md ## Availability."},
	{"pg.query.allow_rollback", "same as dev", "Enables ComplexQuery's \"rollback\" flag ; ungranted is a hard error, not a silent degrade. See specs/complex-query.md ## Availability."},
	...
	{"http.typescript.enable", "false (true if dev)", "Serve GET /rel/database.ts (the introspected schema as TypeScript types plus a few query-building helpers) and GET /rel/database.json (the same introspected structure as plain JSON — specs/database-json.md)."},
	{"http.typescript.schemas", "(every schema, aside from pg_catalog)", "Comma-separated whitelist of schemas GET /rel/database.ts and GET /rel/database.json may export ; intersected with either endpoint's own ?schemas= query param."},
