...
// detail's tier 2 on the /rpc plain-text path : fn_secret's underlying
...
func TestHandler_SecretRoute_PermissionDenied_IsClassified(t *testing.T) {
	req := httptest.NewRequest("GET", "/rpc/public/fn_secret", nil)
	...
	req2 := httptest.NewRequest("GET", "/rpc/public/fn_secret", nil)
